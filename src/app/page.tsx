                  ...
                  <div className="flex items-center">
                    ...
                    <div className="ml-5 w-0 flex-1">
                      <dl>
                        ...
                        <dd className="text-lg font-medium text-gray-900">85.2%</dd>
                      </dl>
                    </div>
                  </div>
                </div>
          ...
          {activeTab === 'classes' && (
            <div className="bg-white shadow rounded-lg">
              <div className="px-4 py-5 sm:p-6">
                <h3 className="text-lg leading-6 font-medium text-gray-900 mb-4">Classes</h3>
            ...
            <div className="bg-white shadow rounded-lg">
              <div className="px-4 py-5 sm:p-6">
                ...
                <div className="text-center py-12">
                  ...
                  <p className="mt-1 text-sm text-gray-500">Add students to your classes to get started.</p>
                </div>
              </div>
            </div>
          )}
            ...
            <div className="bg-white shadow rounded-lg">
              <div className="px-4 py-5 sm:p-6">
                ...
                <div className="text-center py-12">
                  ...
                  <p className="mt-1 text-sm text-gray-500">Start tracking attendance for your class sessions.</p>
                </div>
              </div>
            </div>
          )}
            ...
            <div className="bg-white shadow rounded-lg">
              <div className="px-4 py-5 sm:p-6">
                ...
                <div className="text-center py-12">
                  ...
                  <p className="mt-1 text-sm text-gray-500">Create assignments to track student progress.</p>
                  <div className="mt-6">
            ...
            <div className="bg-white shadow rounded-lg">
              <div className="px-4 py-5 sm:p-6">
                ...
                <div className="text-center py-12">
                  ...
                  <p className="mt-1 text-sm text-gray-500">Grades will appear here once assignments are graded.</p>
                </div>
              </div>
            </div>
          )}
